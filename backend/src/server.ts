...
// Define the URL of your Vercel frontend.
// This allows your backend to accept requests from your deployed frontend.
const vercelUrl = process.env.VITE_FRONTEND_URL || 'http://localhost:3000';
...
const app = express()
app.use(cors(corsOptions)) // Use the correctly configured CORS middleware
